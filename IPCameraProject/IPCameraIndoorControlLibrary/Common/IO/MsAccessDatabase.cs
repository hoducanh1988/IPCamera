...
namespace IPCameraIndoorControlLibrary.Common.IO {
    ...
    public class MsAccessDatabase {
        ...
        //constructor
        public MsAccessDatabase(string access_file_fullname) {
        ...
        /// <param name="table_name"></param>
        /// <param name="t"></param>
        /// <param name="ignore_column_name"></param>
        /// <returns></returns>
        ...
        /// <param name="table_name"></param>
        /// <param name="row_quantity"></param>
        /// <param name="selected_Field"></param>
        /// <returns></returns>
        ...
        /// <param name="table_name"></param>
        /// <param name="row_quantity"></param>
        /// <param name="Field_Order"></param>
        /// <param name="ref_Field1"></param>
        /// <param name="field_Value1"></param>
        /// <param name="ref_Field2"></param>
        /// <param name="field_Value2"></param>
        /// <param name="ref_Field3"></param>
        /// <param name="field_Value3"></param>
        /// <returns></returns>
